...
//  RedAlert (from HM10 Serial project: https://github.com/hoiberg/HM10-BluetoothSerial-iOS)
//
...
/// Global serial handler, don't forget to initialize it with init(delegate:)
